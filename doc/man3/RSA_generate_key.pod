...
Applications should instead use EVP_RSA_gen(), L<OPENSSL_BOX_EVP_PKEY_Q_keygen(3)>, or
L<OPENSSL_BOX_EVP_PKEY_keygen_init(3)> and L<OPENSSL_BOX_EVP_PKEY_keygen(3)>.
