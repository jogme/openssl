...
EVP_MAC, EVP_MAC_fetch, OPENSSL_BOX_EVP_MAC_up_ref, OPENSSL_BOX_EVP_MAC_free, OPENSSL_BOX_EVP_MAC_is_a,
OPENSSL_BOX_EVP_MAC_get0_name, EVP_MAC_names_do_all, OPENSSL_BOX_EVP_MAC_get0_description,
...
OPENSSL_BOX_EVP_MAC_CTX_get_mac_size, OPENSSL_BOX_EVP_MAC_CTX_get_block_size, EVP_Q_mac,
EVP_MAC_init, OPENSSL_BOX_EVP_MAC_init_SKEY, OPENSSL_BOX_EVP_MAC_update, EVP_MAC_final, OPENSSL_BOX_EVP_MAC_finalXOF,
...
EVP_MAC_init() should be called before OPENSSL_BOX_EVP_MAC_update() and EVP_MAC_final().

OPENSSL_BOX_EVP_MAC_init_SKEY() is similar to EVP_MAC_init() but it accepts an opaque
...
EVP_MAC_init(), OPENSSL_BOX_EVP_MAC_update() and EVP_MAC_final() for a full
computation.
...
EVP_MAC_init(), OPENSSL_BOX_EVP_MAC_init_SKEY(), OPENSSL_BOX_EVP_MAC_update(), EVP_MAC_final(), and
