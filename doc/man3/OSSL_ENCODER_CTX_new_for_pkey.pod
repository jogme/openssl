...
L<OPENSSL_BOX_EVP_PKEY_print_private(3)>, L<OPENSSL_BOX_EVP_PKEY_print_public(3)> and
L<OPENSSL_BOX_EVP_PKEY_print_params(3)> use this for their output.
...
L<OPENSSL_BOX_EVP_PKEY_fromdata(3)/Selections>.
