...
OPENSSL_BOX_d2i_PrivateKey_ex, OPENSSL_BOX_d2i_PrivateKey, OPENSSL_BOX_d2i_PublicKey, OPENSSL_BOX_d2i_KeyParams,
OPENSSL_BOX_d2i_AutoPrivateKey_ex,  OPENSSL_BOX_d2i_AutoPrivateKey, OPENSSL_BOX_i2d_PrivateKey,
OPENSSL_BOX_i2d_PKCS8PrivateKey, OPENSSL_BOX_i2d_PublicKey, OPENSSL_BOX_i2d_KeyParams, OPENSSL_BOX_i2d_KeyParams_bio,
d2i_PrivateKey_ex_bio, d2i_PrivateKey_bio, d2i_PrivateKey_ex_fp,
d2i_PrivateKey_fp, OPENSSL_BOX_d2i_KeyParams_bio, i2d_PrivateKey_bio, i2d_PrivateKey_fp
...
OPENSSL_BOX_d2i_PrivateKey_ex() decodes a private key using algorithm I<type>. It attempts
...
OPENSSL_BOX_d2i_PrivateKey() does the same as OPENSSL_BOX_d2i_PrivateKey_ex() except that the default
library context and property query string are used.
OPENSSL_BOX_d2i_PublicKey() does the same for public keys.
OPENSSL_BOX_d2i_KeyParams() does the same for key parameters.

The d2i_PrivateKey_ex_bio() and d2i_PrivateKey_bio() functions are similar to
OPENSSL_BOX_d2i_PrivateKey_ex() and OPENSSL_BOX_d2i_PrivateKey() respectively except that they decode
...
OPENSSL_BOX_d2i_AutoPrivateKey_ex() and OPENSSL_BOX_d2i_AutoPrivateKey() are similar to
OPENSSL_BOX_d2i_PrivateKey_ex() and OPENSSL_BOX_d2i_PrivateKey() respectively except that they attempt
to automatically detect the private key format.

OPENSSL_BOX_i2d_PrivateKey() encodes I<a>. It uses a key specific format or, if none is
defined for that key type, PKCS#8 unencrypted PrivateKeyInfo format.
OPENSSL_BOX_i2d_PKCS8PrivateKey() does the same using only the PKCS#8 unencrypted
PrivateKeyInfo format.
OPENSSL_BOX_i2d_PublicKey() does the same for public keys.
OPENSSL_BOX_i2d_KeyParams() does the same for key parameters.
...
To decode a key with type B<EVP_PKEY_EC>, OPENSSL_BOX_d2i_PublicKey() requires I<*a> to be
a non-NULL EVP_PKEY structure assigned an EC_KEY structure referencing the proper
EC_GROUP.

=head1 RETURN VALUES

The OPENSSL_BOX_d2i_PrivateKey_ex(), OPENSSL_BOX_d2i_PrivateKey(), OPENSSL_BOX_d2i_AutoPrivateKey_ex(),
OPENSSL_BOX_d2i_AutoPrivateKey(), d2i_PrivateKey_ex_bio(), d2i_PrivateKey_bio(),
d2i_PrivateKey_ex_fp(), d2i_PrivateKey_fp(), OPENSSL_BOX_d2i_PublicKey(), OPENSSL_BOX_d2i_KeyParams()
and OPENSSL_BOX_d2i_KeyParams_bio() functions return a valid B<EVP_PKEY> structure or NULL if
an error occurs. The error code can be obtained by calling L<ERR_get_error(3)>.

OPENSSL_BOX_i2d_PrivateKey(), OPENSSL_BOX_i2d_PKCS8PrivateKey(), OPENSSL_BOX_i2d_PublicKey() and OPENSSL_BOX_i2d_KeyParams()
...
i2d_PrivateKey_bio(), i2d_PrivateKey_fp() and OPENSSL_BOX_i2d_KeyParams_bio() return 1 if
...
OPENSSL_BOX_d2i_PrivateKey_ex(), d2i_PrivateKey_ex_bio(), d2i_PrivateKey_ex_fp(), and
OPENSSL_BOX_d2i_AutoPrivateKey_ex() were added in OpenSSL 3.0.

OPENSSL_BOX_i2d_PKCS8PrivateKey() was added in OpenSSL 3.6.
