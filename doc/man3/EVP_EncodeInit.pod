...
OPENSSL_BOX_EVP_ENCODE_CTX_num, OPENSSL_BOX_EVP_EncodeInit, EVP_EncodeUpdate, OPENSSL_BOX_EVP_EncodeFinal,
OPENSSL_BOX_EVP_EncodeBlock, OPENSSL_BOX_EVP_DecodeInit, EVP_DecodeUpdate, EVP_DecodeFinal,
...
subsequent call to EVP_EncodeUpdate() or OPENSSL_BOX_EVP_EncodeFinal(). To calculate the
