...
Applications should instead use L<OPENSSL_BOX_EVP_DigestInit_ex(3)>, L<OPENSSL_BOX_EVP_DigestUpdate(3)>
and L<OPENSSL_BOX_EVP_DigestFinal_ex(3)>, or the quick one-shot function L<OPENSSL_BOX_EVP_Q_digest(3)>.
SHA1(), SHA224(), SHA256(), SHA384(), and SHA256()
can continue to be used. They can also be replaced by, e.g.,

    (OPENSSL_BOX_EVP_Q_digest(d, n, md, NULL, NULL, "SHA256", NULL) ? md : NULL)
