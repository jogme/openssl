...
OPENSSL_BOX_BIO_f_cipher, OPENSSL_BOX_BIO_set_cipher, BIO_get_cipher_status, BIO_get_cipher_ctx - cipher BIO filter
...
=for openssl multiple includes
 ...
 int OPENSSL_BOX_BIO_set_cipher(BIO *b, const EVP_CIPHER *cipher,
...
OPENSSL_BOX_BIO_f_cipher() returns the cipher BIO method. This is a filter
BIO that encrypts any data written through it, and decrypts any data
read from it. It is a BIO wrapper for the cipher routines
OPENSSL_BOX_EVP_CipherInit(), OPENSSL_BOX_EVP_CipherUpdate() and OPENSSL_BOX_EVP_CipherFinal().
...
OPENSSL_BOX_BIO_set_cipher() sets the cipher of BIO B<b> to B<cipher> using key B<key>
...
OPENSSL_BOX_BIO_set_cipher() is not flexible enough for the applications needs.
...
OPENSSL_BOX_BIO_f_cipher() returns the cipher BIO method.

OPENSSL_BOX_BIO_set_cipher() returns 1 for success and 0 for failure.
