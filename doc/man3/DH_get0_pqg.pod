...
Applications should instead use L<OPENSSL_BOX_EVP_PKEY_get_bn_param(3)> for any methods that
...
OPENSSL_BOX_EVP_PKEY_CTX_set_params() and OPENSSL_BOX_EVP_PKEY_get_int_param() using the parameter key
