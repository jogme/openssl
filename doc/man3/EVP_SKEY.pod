...
EVP_SKEY_import, EVP_SKEY_import_raw_key, OPENSSL_BOX_EVP_SKEY_up_ref,
EVP_SKEY_export, EVP_SKEY_get0_raw_key, OPENSSL_BOX_EVP_SKEY_get0_key_id,
OPENSSL_BOX_EVP_SKEY_get0_skeymgmt_name, OPENSSL_BOX_EVP_SKEY_get0_provider_name,
OPENSSL_BOX_EVP_SKEY_free, OPENSSL_BOX_EVP_SKEY_is_a, EVP_SKEY_to_provider
...
OPENSSL_BOX_EVP_SKEY_free(), EVP_SKEY_get0_raw_key(), EVP_SKEY_import(),
EVP_SKEY_import_raw_key(), OPENSSL_BOX_EVP_SKEY_up_ref(), EVP_SKEY_generate(),
OPENSSL_BOX_EVP_SKEY_get0_key_id(), OPENSSL_BOX_EVP_SKEY_get0_provider_name(),
OPENSSL_BOX_EVP_SKEY_get0_skeymgmt_name(), OPENSSL_BOX_EVP_SKEY_is_a(), EVP_SKEY_to_provider()
