...
OPENSSL_BOX_BIO_f_base64 - base64 BIO filter
...
OPENSSL_BOX_BIO_f_base64() returns the base64 BIO method. This is a filter
...
character (B<->, see L<OPENSSL_BOX_EVP_DecodeUpdate(3)>) occurs as the first byte after a
...
OPENSSL_BOX_BIO_f_base64() returns the base64 BIO method.
...
L<OPENSSL_BOX_EVP_DecodeUpdate(3)>.
