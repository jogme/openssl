...
OPENSSL_BOX_EVP_PKEY_digestsign_supports_digest - indicate support for signature digest
...
The OPENSSL_BOX_EVP_PKEY_digestsign_supports_digest() function queries whether the message
...
The OPENSSL_BOX_EVP_PKEY_digestsign_supports_digest() function returns 1 if the message
...
L<OPENSSL_BOX_EVP_DigestSignInit_ex(3)>,

=head1 HISTORY

The OPENSSL_BOX_EVP_PKEY_digestsign_supports_digest() function was added in OpenSSL 3.0.
