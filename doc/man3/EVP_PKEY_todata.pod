...
OPENSSL_BOX_EVP_PKEY_todata, EVP_PKEY_export
...
EVP_PKEY_export() is similar to OPENSSL_BOX_EVP_PKEY_todata() but uses a callback
...
OPENSSL_BOX_EVP_PKEY_todata() and EVP_PKEY_export() return 1 for success and 0 for failure.
