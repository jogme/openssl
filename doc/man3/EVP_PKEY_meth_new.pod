...
OPENSSL_BOX_EVP_PKEY_meth_new, OPENSSL_BOX_EVP_PKEY_meth_free, EVP_PKEY_meth_copy, OPENSSL_BOX_EVP_PKEY_meth_find,
...
valid. They are called by L<OPENSSL_BOX_EVP_PKEY_verify_init(3)> and L<EVP_PKEY_verify(3)>.
...
L<OPENSSL_BOX_EVP_PKEY_verify_recover_init(3)> and L<EVP_PKEY_verify_recover(3)>.
...
They are called by L<OPENSSL_BOX_EVP_PKEY_encrypt_init(3)> and L<EVP_PKEY_encrypt(3)>.
...
They are called by L<OPENSSL_BOX_EVP_PKEY_decrypt_init(3)> and L<EVP_PKEY_decrypt(3)>.
...
OPENSSL_BOX_EVP_PKEY_meth_free() and EVP_PKEY_meth_copy() do not return values.
