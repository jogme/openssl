...
OPENSSL_BOX_EVP_PKEY_get_group_name - get group name of a key

=head1 SYNOPSIS

 #include <openssl/evp.h>

 int OPENSSL_BOX_EVP_PKEY_get_group_name(EVP_PKEY *pkey, char *gname, size_t gname_sz,
                             size_t *gname_len);

=head1 DESCRIPTION

OPENSSL_BOX_EVP_PKEY_get_group_name() fills in the group name of the I<pkey> into
...
OPENSSL_BOX_EVP_PKEY_get_group_name() returns 1 if the group name could be filled in,
otherwise 0.
