...
Applications should instead use L<OPENSSL_BOX_EVP_PKEY_sign_init(3)>, L<OPENSSL_BOX_EVP_PKEY_sign(3)>,
L<OPENSSL_BOX_EVP_PKEY_verify_init(3)> and L<OPENSSL_BOX_EVP_PKEY_verify(3)>.
