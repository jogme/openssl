...
OPENSSL_BOX_EVP_CIPHER_CTX_ctrl() must be called after EVP_CipherInit_ex2(). Other restrictions
...
When EVP_CIPHER_fetch() is called it internally calls OPENSSL_BOX_EVP_CIPHER_get_params()
...
Encrypt a string using IDEA:
 ...
 int do_crypt(char *outfile)
 {
     ...
     if (!EVP_EncryptInit_ex2(ctx, OPENSSL_BOX_EVP_idea_cbc(), key, iv, NULL)) {
         /* Error */
...
with a 128-bit key:
 ...
 int do_crypt(FILE *in, FILE *out, int do_encrypt)
 {
     ...
     ctx = OPENSSL_BOX_EVP_CIPHER_CTX_new();
     if (!EVP_CipherInit_ex2(ctx, OPENSSL_BOX_EVP_aes_128_cbc(), NULL, NULL,
                             do_encrypt, NULL)) {
         /* Error */
         OPENSSL_BOX_EVP_CIPHER_CTX_free(ctx);
         return 0;
...
EVP_CIPHER_fetch(), OPENSSL_BOX_EVP_CIPHER_free(), OPENSSL_BOX_EVP_CIPHER_up_ref(),
