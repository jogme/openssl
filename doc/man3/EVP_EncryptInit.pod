...
OPENSSL_BOX_EVP_CIPHER_fetch,
OPENSSL_BOX_EVP_CIPHER_up_ref,
OPENSSL_BOX_EVP_CIPHER_free,
OPENSSL_BOX_EVP_CIPHER_CTX_new,
OPENSSL_BOX_EVP_CIPHER_CTX_reset,
OPENSSL_BOX_EVP_CIPHER_CTX_free,
OPENSSL_BOX_EVP_CIPHER_CTX_dup,
OPENSSL_BOX_EVP_CIPHER_CTX_copy,
OPENSSL_BOX_EVP_EncryptInit_ex,
OPENSSL_BOX_EVP_EncryptInit_ex2,
OPENSSL_BOX_EVP_EncryptUpdate,
OPENSSL_BOX_EVP_EncryptFinal_ex,
OPENSSL_BOX_EVP_DecryptInit_ex,
OPENSSL_BOX_EVP_DecryptInit_ex2,
OPENSSL_BOX_EVP_DecryptUpdate,
OPENSSL_BOX_EVP_DecryptFinal_ex,
OPENSSL_BOX_EVP_CipherInit_ex,
OPENSSL_BOX_EVP_CipherInit_ex2,
OPENSSL_BOX_EVP_CipherInit_SKEY,
OPENSSL_BOX_EVP_CipherUpdate,
OPENSSL_BOX_EVP_CipherFinal_ex,
OPENSSL_BOX_EVP_CIPHER_CTX_set_key_length,
OPENSSL_BOX_EVP_CIPHER_CTX_ctrl,
OPENSSL_BOX_EVP_EncryptInit,
OPENSSL_BOX_EVP_EncryptFinal,
OPENSSL_BOX_EVP_DecryptInit,
OPENSSL_BOX_EVP_DecryptFinal,
OPENSSL_BOX_EVP_CipherInit,
OPENSSL_BOX_EVP_CipherFinal,
OPENSSL_BOX_EVP_Cipher,
OPENSSL_BOX_EVP_CIPHER_can_pipeline,
OPENSSL_BOX_EVP_CipherPipelineEncryptInit,
OPENSSL_BOX_EVP_CipherPipelineDecryptInit,
OPENSSL_BOX_EVP_CipherPipelineUpdate,
OPENSSL_BOX_EVP_CipherPipelineFinal,
OPENSSL_BOX_EVP_get_cipherbyname,
EVP_get_cipherbynid,
EVP_get_cipherbyobj,
OPENSSL_BOX_EVP_CIPHER_is_a,
OPENSSL_BOX_EVP_CIPHER_get0_name,
OPENSSL_BOX_EVP_CIPHER_get0_description,
OPENSSL_BOX_EVP_CIPHER_names_do_all,
OPENSSL_BOX_EVP_CIPHER_get0_provider,
OPENSSL_BOX_EVP_CIPHER_get_nid,
OPENSSL_BOX_EVP_CIPHER_get_params,
OPENSSL_BOX_EVP_CIPHER_gettable_params,
OPENSSL_BOX_EVP_CIPHER_get_block_size,
OPENSSL_BOX_EVP_CIPHER_get_key_length,
OPENSSL_BOX_EVP_CIPHER_get_iv_length,
OPENSSL_BOX_EVP_CIPHER_get_flags,
OPENSSL_BOX_EVP_CIPHER_get_mode,
OPENSSL_BOX_EVP_CIPHER_get_type,
OPENSSL_BOX_EVP_CIPHER_CTX_cipher,
OPENSSL_BOX_EVP_CIPHER_CTX_get0_cipher,
OPENSSL_BOX_EVP_CIPHER_CTX_get1_cipher,
EVP_CIPHER_CTX_get0_name,
OPENSSL_BOX_EVP_CIPHER_CTX_get_nid,
OPENSSL_BOX_EVP_CIPHER_CTX_get_params,
OPENSSL_BOX_EVP_CIPHER_gettable_ctx_params,
OPENSSL_BOX_EVP_CIPHER_CTX_gettable_params,
OPENSSL_BOX_EVP_CIPHER_CTX_set_params,
OPENSSL_BOX_EVP_CIPHER_settable_ctx_params,
OPENSSL_BOX_EVP_CIPHER_CTX_settable_params,
OPENSSL_BOX_EVP_CIPHER_CTX_get_block_size,
OPENSSL_BOX_EVP_CIPHER_CTX_get_key_length,
OPENSSL_BOX_EVP_CIPHER_CTX_get_iv_length,
OPENSSL_BOX_EVP_CIPHER_CTX_get_tag_length,
OPENSSL_BOX_EVP_CIPHER_CTX_get_app_data,
OPENSSL_BOX_EVP_CIPHER_CTX_set_app_data,
EVP_CIPHER_CTX_flags,
OPENSSL_BOX_EVP_CIPHER_CTX_set_flags,
OPENSSL_BOX_EVP_CIPHER_CTX_clear_flags,
OPENSSL_BOX_EVP_CIPHER_CTX_test_flags,
EVP_CIPHER_CTX_get_type,
EVP_CIPHER_CTX_get_mode,
OPENSSL_BOX_EVP_CIPHER_CTX_get_num,
OPENSSL_BOX_EVP_CIPHER_CTX_set_num,
OPENSSL_BOX_EVP_CIPHER_CTX_is_encrypting,
OPENSSL_BOX_EVP_CIPHER_param_to_asn1,
OPENSSL_BOX_EVP_CIPHER_asn1_to_param,
OPENSSL_BOX_EVP_CIPHER_CTX_set_padding,
OPENSSL_BOX_EVP_enc_null,
OPENSSL_BOX_EVP_CIPHER_do_all_provided,
EVP_CIPHER_nid,
EVP_CIPHER_name,
...
=for openssl generic
 ...
 int OPENSSL_BOX_EVP_EncryptInit_ex(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *type,
                        ENGINE *impl, const unsigned char *key, const unsigned char *iv);
 int OPENSSL_BOX_EVP_EncryptInit_ex2(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *type,
                         const unsigned char *key, const unsigned char *iv,
                         const OSSL_PARAM params[]);
 int OPENSSL_BOX_EVP_EncryptUpdate(EVP_CIPHER_CTX *ctx, unsigned char *out,
                       int *outl, const unsigned char *in, int inl);
 int OPENSSL_BOX_EVP_EncryptFinal_ex(EVP_CIPHER_CTX *ctx, unsigned char *out, int *outl);

 int OPENSSL_BOX_EVP_DecryptInit_ex(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *type,
                        ENGINE *impl, const unsigned char *key, const unsigned char *iv);
 int OPENSSL_BOX_EVP_DecryptInit_ex2(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *type,
                         const unsigned char *key, const unsigned char *iv,
                         const OSSL_PARAM params[]);
 int OPENSSL_BOX_EVP_DecryptUpdate(EVP_CIPHER_CTX *ctx, unsigned char *out,
                       int *outl, const unsigned char *in, int inl);
 int OPENSSL_BOX_EVP_DecryptFinal_ex(EVP_CIPHER_CTX *ctx, unsigned char *outm, int *outl);

 int OPENSSL_BOX_EVP_CipherInit_ex(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *type,
                       ENGINE *impl, const unsigned char *key, const unsigned char *iv, int enc);
 int OPENSSL_BOX_EVP_CipherInit_ex2(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *type,
                        const unsigned char *key, const unsigned char *iv,
 ...
 int OPENSSL_BOX_EVP_CipherInit_SKEY(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher,
                         ...
                         int enc, const OSSL_PARAM params[]);
 int OPENSSL_BOX_EVP_CipherUpdate(EVP_CIPHER_CTX *ctx, unsigned char *out,
                      int *outl, const unsigned char *in, int inl);
 int OPENSSL_BOX_EVP_CipherFinal_ex(EVP_CIPHER_CTX *ctx, unsigned char *outm, int *outl);

 int OPENSSL_BOX_EVP_EncryptInit(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *type,
                     const unsigned char *key, const unsigned char *iv);
 int OPENSSL_BOX_EVP_EncryptFinal(EVP_CIPHER_CTX *ctx, unsigned char *out, int *outl);

 int OPENSSL_BOX_EVP_DecryptInit(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *type,
                     const unsigned char *key, const unsigned char *iv);
 int OPENSSL_BOX_EVP_DecryptFinal(EVP_CIPHER_CTX *ctx, unsigned char *outm, int *outl);

 int OPENSSL_BOX_EVP_CipherInit(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *type,
                    const unsigned char *key, const unsigned char *iv, int enc);
 int OPENSSL_BOX_EVP_CipherFinal(EVP_CIPHER_CTX *ctx, unsigned char *outm, int *outl);
 ...
 int OPENSSL_BOX_EVP_CIPHER_CTX_set_padding(EVP_CIPHER_CTX *x, int padding);
 int OPENSSL_BOX_EVP_CIPHER_CTX_set_key_length(EVP_CIPHER_CTX *x, int keylen);
 int OPENSSL_BOX_EVP_CIPHER_CTX_ctrl(EVP_CIPHER_CTX *ctx, int cmd, int p1, void *p2);
 ...
 int OPENSSL_BOX_EVP_CIPHER_get_nid(const EVP_CIPHER *e);
 ...
 int OPENSSL_BOX_EVP_CIPHER_get_block_size(const EVP_CIPHER *e);
 int OPENSSL_BOX_EVP_CIPHER_get_key_length(const EVP_CIPHER *e);
 int OPENSSL_BOX_EVP_CIPHER_get_iv_length(const EVP_CIPHER *e);
 unsigned long OPENSSL_BOX_EVP_CIPHER_get_flags(const EVP_CIPHER *e);
 unsigned long OPENSSL_BOX_EVP_CIPHER_get_mode(const EVP_CIPHER *e);
 ...
 EVP_CIPHER *OPENSSL_BOX_EVP_CIPHER_CTX_get1_cipher(const EVP_CIPHER_CTX *ctx);
 ...
 void OPENSSL_BOX_EVP_CIPHER_CTX_set_app_data(const EVP_CIPHER_CTX *ctx, void *data);
...
=item OPENSSL_BOX_EVP_CIPHER_fetch()
...
=item OPENSSL_BOX_EVP_CIPHER_CTX_dup()

Can be used to duplicate the cipher state from I<in>.  This is useful
to avoid multiple OPENSSL_BOX_EVP_CIPHER_fetch() calls or if large amounts of data are to be
fed which only differ in the last few bytes.

=item OPENSSL_BOX_EVP_CIPHER_CTX_copy()

Can be used to copy the cipher state from I<in> to I<out>.

=item OPENSSL_BOX_EVP_CIPHER_CTX_ctrl()

I<This is a legacy method.> OPENSSL_BOX_EVP_CIPHER_CTX_set_params() and
OPENSSL_BOX_EVP_CIPHER_CTX_get_params() is the mechanism that should be used to set and get
...
OPENSSL_BOX_EVP_CIPHER_CTX_ctrl() must be called after OPENSSL_BOX_EVP_CipherInit_ex2(). Other restrictions
...
parameters with keys defined by OpenSSL and call OPENSSL_BOX_EVP_CIPHER_CTX_get_params() or
OPENSSL_BOX_EVP_CIPHER_CTX_set_params() as is appropriate for each control command.

See L</CONTROLS> below for more information, including what translations are
being done.

=item OPENSSL_BOX_EVP_CIPHER_get_params()

Retrieves the requested list of algorithm I<params> from a CIPHER I<cipher>.
See L</PARAMETERS> below for more information.

=item OPENSSL_BOX_EVP_CIPHER_CTX_get_params()

Retrieves the requested list of I<params> from CIPHER context I<ctx>.
See L</PARAMETERS> below for more information.

=item OPENSSL_BOX_EVP_CIPHER_CTX_set_params()

Sets the list of I<params> into a CIPHER context I<ctx>.
See L</PARAMETERS> below for more information.

=item OPENSSL_BOX_EVP_CIPHER_gettable_params()

Get a constant L<OSSL_PARAM(3)> array that describes the retrievable parameters
that can be used with OPENSSL_BOX_EVP_CIPHER_get_params().

=item OPENSSL_BOX_EVP_CIPHER_gettable_ctx_params() and OPENSSL_BOX_EVP_CIPHER_CTX_gettable_params()

Get a constant L<OSSL_PARAM(3)> array that describes the retrievable parameters
that can be used with OPENSSL_BOX_EVP_CIPHER_CTX_get_params().
OPENSSL_BOX_EVP_CIPHER_gettable_ctx_params() returns the parameters that can be retrieved
from the algorithm, whereas OPENSSL_BOX_EVP_CIPHER_CTX_gettable_params() returns the
parameters that can be retrieved in the context's current state.

=item OPENSSL_BOX_EVP_CIPHER_settable_ctx_params() and OPENSSL_BOX_EVP_CIPHER_CTX_settable_params()

Get a constant L<OSSL_PARAM(3)> array that describes the settable parameters
that can be used with OPENSSL_BOX_EVP_CIPHER_CTX_set_params().
OPENSSL_BOX_EVP_CIPHER_settable_ctx_params() returns the parameters that can be set from the
algorithm, whereas OPENSSL_BOX_EVP_CIPHER_CTX_settable_params() returns the parameters that
can be set in the context's current state.

=item OPENSSL_BOX_EVP_EncryptInit_ex2()

Sets up cipher context I<ctx> for encryption with cipher I<type>. I<ctx> B<MUST NOT> be NULL.
I<type> is typically supplied by calling OPENSSL_BOX_EVP_CIPHER_fetch(). I<type> may also be set
using legacy functions such as OPENSSL_BOX_EVP_aes_256_cbc(), but this is not recommended
...
=item OPENSSL_BOX_EVP_EncryptInit_ex()

This legacy function is similar to OPENSSL_BOX_EVP_EncryptInit_ex2() when I<impl> is NULL.
The implementation of the I<type> from the I<impl> engine will be used if it
exists.

=item OPENSSL_BOX_EVP_EncryptUpdate()
...
If padding is enabled (the default) then OPENSSL_BOX_EVP_EncryptFinal_ex() encrypts
...
calls to OPENSSL_BOX_EVP_EncryptUpdate() should be made.

If padding is disabled then OPENSSL_BOX_EVP_EncryptFinal_ex() will not encrypt any more
data and it will return an error if any data remains in a partial block:
that is if the total data length is not a multiple of the block size.

=item OPENSSL_BOX_EVP_DecryptInit_ex2(), OPENSSL_BOX_EVP_DecryptInit_ex(), OPENSSL_BOX_EVP_DecryptUpdate()
and OPENSSL_BOX_EVP_DecryptFinal_ex()

These functions are the corresponding decryption operations.
OPENSSL_BOX_EVP_DecryptFinal() will return an error code if padding is enabled and the
...
=item OPENSSL_BOX_EVP_CipherInit_ex2(), OPENSSL_BOX_EVP_CipherInit_ex(), OPENSSL_BOX_EVP_CipherUpdate() and
OPENSSL_BOX_EVP_CipherFinal_ex()
...
=item OPENSSL_BOX_EVP_CipherInit_SKEY()

This function is similar to OPENSSL_BOX_EVP_CipherInit_ex2() but accepts a
symmetric key object of type I<EVP_SKEY> as a key.

=item OPENSSL_BOX_EVP_CIPHER_CTX_reset()
...
OPENSSL_BOX_EVP_CipherInit() / OPENSSL_BOX_EVP_CipherUpdate() / OPENSSL_BOX_EVP_CipherFinal() series of calls.

=item OPENSSL_BOX_EVP_EncryptInit(), OPENSSL_BOX_EVP_DecryptInit() and OPENSSL_BOX_EVP_CipherInit()

Behave in a similar way to OPENSSL_BOX_EVP_EncryptInit_ex(), OPENSSL_BOX_EVP_DecryptInit_ex() and
OPENSSL_BOX_EVP_CipherInit_ex() except if the I<type> is not a fetched cipher they use the
default implementation of the I<type>.

=item OPENSSL_BOX_EVP_EncryptFinal(), OPENSSL_BOX_EVP_DecryptFinal() and OPENSSL_BOX_EVP_CipherFinal()

Identical to OPENSSL_BOX_EVP_EncryptFinal_ex(), OPENSSL_BOX_EVP_DecryptFinal_ex() and
OPENSSL_BOX_EVP_CipherFinal_ex(). In previous releases they also cleaned up
the I<ctx>, but this is no longer done and EVP_CIPHER_CTX_cleanup()
must be called to free any context resources.

=item OPENSSL_BOX_EVP_Cipher()
...
OPENSSL_BOX_EVP_CIPHER_get_block_size().  If it isn't, the result is undefined.  If the cipher
...
in applications, please consider using OPENSSL_BOX_EVP_CipherUpdate() and
OPENSSL_BOX_EVP_CipherFinal_ex() instead.

=item OPENSSL_BOX_EVP_CIPHER_can_pipeline()

This function checks if a B<EVP_CIPHER> fetched using OPENSSL_BOX_EVP_CIPHER_fetch() supports
cipher pipelining. If the cipher supports pipelining, it returns 1, otherwise 0.
This function will return 0 for non-fetched ciphers such as OPENSSL_BOX_EVP_aes_128_gcm().
...
data in one set of OPENSSL_BOX_EVP_CipherUpdate()/OPENSSL_BOX_EVP_CipherFinal calls, thereby allowing
...
For non-fetched ciphers, OPENSSL_BOX_EVP_CipherPipelineEncryptInit() or
OPENSSL_BOX_EVP_CipherPipelineDecryptInit() may be directly called, which will perform a
fetch and return an error if a pipeline supported implementation is not found.

=item OPENSSL_BOX_EVP_CipherPipelineEncryptInit(), OPENSSL_BOX_EVP_CipherPipelineDecryptInit(), OPENSSL_BOX_EVP_CipherPipelineUpdate() and OPENSSL_BOX_EVP_CipherPipelineFinal()

These functions can be used to perform multiple encryption or decryption
operations in parallel. OPENSSL_BOX_EVP_CIPHER_can_pipeline() may be called to check if the
cipher supports pipelining. These functions are analogous to
OPENSSL_BOX_EVP_EncryptInit_ex2(), OPENSSL_BOX_EVP_DecryptInit_ex2(), OPENSSL_BOX_EVP_CipherUpdate() and
OPENSSL_BOX_EVP_CipherFinal() but take an array of pointers for iv, input and output buffers.
...
For size requirement of the output buffers, see the description of OPENSSL_BOX_EVP_CipherUpdate().

The OPENSSL_BOX_EVP_CipherPipelineUpdate() function can be called multiple times to encrypt
...
=item OPENSSL_BOX_EVP_get_cipherbyname(), EVP_get_cipherbynid() and EVP_get_cipherbyobj()

Returns an B<EVP_CIPHER> structure when passed a cipher name, a cipher B<NID> or
an B<ASN1_OBJECT> structure respectively.

OPENSSL_BOX_EVP_get_cipherbyname() will return NULL for algorithms such as "AES-128-SIV",
"AES-128-CBC-CTS" and "CAMELLIA-128-CBC-CTS" which were previously only
accessible via low level interfaces.

The OPENSSL_BOX_EVP_get_cipherbyname() function is present for backwards compatibility with
OpenSSL prior to version 3 and is different to the OPENSSL_BOX_EVP_CIPHER_fetch() function
...
to OPENSSL_BOX_EVP_EncryptInit_ex()) an implementation of the cipher will be implicitly
fetched from the loaded providers. This fetch could fail if no suitable
implementation is available. Use OPENSSL_BOX_EVP_CIPHER_fetch() instead to explicitly fetch
...
=item OPENSSL_BOX_EVP_CIPHER_get_nid() and OPENSSL_BOX_EVP_CIPHER_CTX_get_nid()
...
B<OPENSSL_BOX_EVP_CipherInit>.

=item OPENSSL_BOX_EVP_CIPHER_CTX_set_flags(), OPENSSL_BOX_EVP_CIPHER_CTX_clear_flags() and OPENSSL_BOX_EVP_CIPHER_CTX_test_flags()

Sets, clears and tests I<ctx> flags.  See L</FLAGS> below for more information.

For provided ciphers OPENSSL_BOX_EVP_CIPHER_CTX_set_flags() should be called only after the
fetched cipher has been assigned to the I<ctx>. It is recommended to use
L</PARAMETERS> instead.

=item OPENSSL_BOX_EVP_CIPHER_CTX_set_padding()

Enables or disables padding. This function should be called after the context
is set up for encryption or decryption with OPENSSL_BOX_EVP_EncryptInit_ex2(),
OPENSSL_BOX_EVP_DecryptInit_ex2(), OPENSSL_BOX_EVP_CipherInit_ex2(), or OPENSSL_BOX_EVP_CipherInit_SKEY(). By
...
=item OPENSSL_BOX_EVP_CIPHER_get_key_length() and OPENSSL_BOX_EVP_CIPHER_CTX_get_key_length()
...
key length for all ciphers. Note: although OPENSSL_BOX_EVP_CIPHER_get_key_length() is fixed for
a given cipher, the value of OPENSSL_BOX_EVP_CIPHER_CTX_get_key_length() may be different for
variable key length ciphers.

=item OPENSSL_BOX_EVP_CIPHER_CTX_set_key_length()

Sets the key length of the cipher context.
If the cipher is a fixed length cipher then attempting to set the key
length to any value other than the fixed value is an error.

=item OPENSSL_BOX_EVP_CIPHER_get_iv_length() and OPENSSL_BOX_EVP_CIPHER_CTX_get_iv_length()
...
=item OPENSSL_BOX_EVP_CIPHER_CTX_get_tag_length()
...
=item OPENSSL_BOX_EVP_CIPHER_get_block_size() and OPENSSL_BOX_EVP_CIPHER_CTX_get_block_size()
...
A value of 0 is returned if, with B<OPENSSL_BOX_EVP_CIPHER_get_block_size()>, the cipher
I<e> is NULL, or, with B<OPENSSL_BOX_EVP_CIPHER_CTX_get_block_size()>, the context
I<ctx> is NULL or has not been properly initialized with a call to
B<OPENSSL_BOX_EVP_CipherInit>.

=item OPENSSL_BOX_EVP_CIPHER_get_type() and EVP_CIPHER_CTX_get_type()
...
=item OPENSSL_BOX_EVP_CIPHER_is_a()
...
OPENSSL_BOX_EVP_CIPHER_fetch()), only cipher names registered with the default library
context (see L<OSSL_LIB_CTX(3)>) will be considered.

=item OPENSSL_BOX_EVP_CIPHER_get0_name() and EVP_CIPHER_CTX_get0_name()

Return the name of the passed cipher or context.  For fetched ciphers with
multiple names, only one of them is returned. See also OPENSSL_BOX_EVP_CIPHER_names_do_all().
I<cipher> B<MUST NOT> be NULL.

=item OPENSSL_BOX_EVP_CIPHER_names_do_all()
...
=item OPENSSL_BOX_EVP_CIPHER_get0_description()
...
=item OPENSSL_BOX_EVP_CIPHER_get0_provider()

Returns an B<OSSL_PROVIDER> pointer to the provider that implements the given
B<EVP_CIPHER>.

=item OPENSSL_BOX_EVP_CIPHER_CTX_get0_cipher()

Returns the B<EVP_CIPHER> structure when passed an B<EVP_CIPHER_CTX> structure.
OPENSSL_BOX_EVP_CIPHER_CTX_get1_cipher() is the same except the ownership is passed to
the caller. Both functions return NULL on error.

=item OPENSSL_BOX_EVP_CIPHER_get_mode() and EVP_CIPHER_CTX_get_mode()
...
=item OPENSSL_BOX_EVP_CIPHER_get_flags()

Returns any flags associated with the cipher. See L</FLAGS>
for a list of currently defined flags.

=item OPENSSL_BOX_EVP_CIPHER_CTX_get_num() and OPENSSL_BOX_EVP_CIPHER_CTX_set_num()
...
=item OPENSSL_BOX_EVP_CIPHER_CTX_is_encrypting()

Reports whether the I<ctx> is being used for encryption or decryption.

=item EVP_CIPHER_CTX_flags()

A deprecated macro calling C<OPENSSL_BOX_EVP_CIPHER_get_flags(OPENSSL_BOX_EVP_CIPHER_CTX_get0_cipher(ctx))>.
Do not use.

=item OPENSSL_BOX_EVP_CIPHER_param_to_asn1()
...
"used" (before any OPENSSL_BOX_EVP_EncryptUpdate(), OPENSSL_BOX_EVP_DecryptUpdate() calls for example).
This function may fail if the cipher does not have any ASN1 support, or if an
uninitialized cipher is passed to it.

=item OPENSSL_BOX_EVP_CIPHER_asn1_to_param()
...
the key is set. For example OPENSSL_BOX_EVP_CipherInit() will be called with the IV and
key set to NULL, OPENSSL_BOX_EVP_CIPHER_asn1_to_param() will be called and finally
OPENSSL_BOX_EVP_CipherInit() again with all parameters except the key set to NULL. It is
possible for this function to fail if the cipher does not have any ASN1 support
or the parameters cannot be set (for example the RC2 effective key length
is not supported.

=item OPENSSL_BOX_EVP_CIPHER_CTX_rand_key()
...
value returned by OPENSSL_BOX_EVP_CIPHER_CTX_get_key_length().

=item OPENSSL_BOX_EVP_CIPHER_do_all_provided()
...
When OPENSSL_BOX_EVP_CIPHER_fetch() is called it internally calls OPENSSL_BOX_EVP_CIPHER_get_params()
and caches the results.

OPENSSL_BOX_EVP_CIPHER_get_params() can be used with the following L<OSSL_PARAM(3)> keys:
...
See L</OPENSSL_BOX_EVP_CIPHER_get_mode() and EVP_CIPHER_CTX_get_mode()> for a list of valid modes.
Use OPENSSL_BOX_EVP_CIPHER_get_mode() to retrieve the cached value.

=item "keylen" (B<OSSL_CIPHER_PARAM_KEYLEN>) <unsigned integer>

Gets the key length for the associated cipher algorithm I<cipher>.
Use OPENSSL_BOX_EVP_CIPHER_get_key_length() to retrieve the cached value.

=item "ivlen" (B<OSSL_CIPHER_PARAM_IVLEN>) <unsigned integer>

Gets the IV length for the associated cipher algorithm I<cipher>.
Use OPENSSL_BOX_EVP_CIPHER_get_iv_length() to retrieve the cached value.
...
Use OPENSSL_BOX_EVP_CIPHER_get_block_size() to retrieve the cached value.

=item "aead" (B<OSSL_CIPHER_PARAM_AEAD>) <integer>

Gets 1 if this is an AEAD cipher algorithm, otherwise it gets 0.
Use (OPENSSL_BOX_EVP_CIPHER_get_flags(cipher) & EVP_CIPH_FLAG_AEAD_CIPHER) to retrieve the
cached value.
...
custom IV is used.
Use (OPENSSL_BOX_EVP_CIPHER_get_flags(cipher) & EVP_CIPH_CUSTOM_IV) to retrieve the
cached value.
...
allows a single call to OPENSSL_BOX_EVP_CipherUpdate().
Use (OPENSSL_BOX_EVP_CIPHER_get_flags(cipher) & EVP_CIPH_FLAG_CTS) to retrieve the
cached value.
...
TLS ciphers.
Use (OPENSSL_BOX_EVP_CIPHER_get_flags(cipher) & EVP_CIPH_FLAG_TLS1_1_MULTIBLOCK) to retrieve the
cached value.
...
The following L<OSSL_PARAM(3)> keys can be used with both OPENSSL_BOX_EVP_CIPHER_CTX_get_params()
and OPENSSL_BOX_EVP_CIPHER_CTX_set_params().
...
See also OPENSSL_BOX_EVP_CIPHER_CTX_set_padding().
...
See also OPENSSL_BOX_EVP_CIPHER_CTX_get_num() and OPENSSL_BOX_EVP_CIPHER_CTX_set_num().
...
See also OPENSSL_BOX_EVP_CIPHER_CTX_get_key_length() and OPENSSL_BOX_EVP_CIPHER_CTX_set_key_length().

=item "tag" (B<OSSL_CIPHER_PARAM_AEAD_TAG>) <octet string>

Gets or sets the AEAD tag for the associated cipher context I<ctx>.
See L<OPENSSL_BOX_EVP_EncryptInit(3)/AEAD Interface>.
...
OPENSSL_BOX_EVP_CipherPipelineEncryptInit() or OPENSSL_BOX_EVP_CipherPipelineDecryptInit().
...
implementation.  Functions like L<OPENSSL_BOX_EVP_PKEY_CTX_get_algor(3)> use this
parameter.
...
Functions like L<OPENSSL_BOX_EVP_CIPHER_CTX_set_algor_params(3)> and
L<OPENSSL_BOX_EVP_CIPHER_CTX_get_algor_params(3)> use this parameter.
...
L<OPENSSL_BOX_EVP_CIPHER_param_to_asn1(3)> and L<OPENSSL_BOX_EVP_CIPHER_asn1_to_param(3)>.
...
The following L<OSSL_PARAM(3)> keys can be used with OPENSSL_BOX_EVP_CIPHER_CTX_get_params():
...
See also OPENSSL_BOX_EVP_CIPHER_CTX_get_iv_length().
...
See also OPENSSL_BOX_EVP_CIPHER_CTX_get_original_iv().
...
See also OPENSSL_BOX_EVP_CIPHER_CTX_get_updated_iv().
...
See also OPENSSL_BOX_EVP_CIPHER_CTX_get_tag_length().
...
OPENSSL_BOX_EVP_EncryptFinal_ex(). It may return 0 if the "encrypt-check" option is set to 0.
...
as OPENSSL_BOX_EVP_EncryptFinal_ex().
GCM should generate an IV internally if the IV is not specified during a
cipher initialisation call such as OPENSSL_BOX_EVP_CipherInit_ex().
...
The following L<OSSL_PARAM(3)> keys can be used with OPENSSL_BOX_EVP_CIPHER_CTX_set_params():
...
Determines if the input length I<inl> passed to OPENSSL_BOX_EVP_EncryptUpdate(),
OPENSSL_BOX_EVP_DecryptUpdate() and OPENSSL_BOX_EVP_CipherUpdate() is the number of bits or number of bytes.
Setting "use-bits" to 1 uses bits. The default is in bytes.
This is only used for B<CFB1> ciphers.

This can be set using OPENSSL_BOX_EVP_CIPHER_CTX_set_flags(ctx, EVP_CIPH_FLAG_LENGTH_BITS).
...
function such as OPENSSL_BOX_EVP_EncryptInit_ex2().
...
The Mappings from OPENSSL_BOX_EVP_CIPHER_CTX_ctrl() identifiers to PARAMETERS are listed
in the following section. See the L</PARAMETERS> section for more details.

OPENSSL_BOX_EVP_CIPHER_CTX_ctrl() can be used to send the following standard controls:

=over 4

=item EVP_CTRL_AEAD_SET_IVLEN and EVP_CTRL_GET_IVLEN

When used with a fetched B<EVP_CIPHER>, OPENSSL_BOX_EVP_CIPHER_CTX_set_params() and
OPENSSL_BOX_EVP_CIPHER_CTX_get_params() get called with an L<OSSL_PARAM(3)> item with the
key "ivlen" (B<OSSL_CIPHER_PARAM_IVLEN>).

=item EVP_CTRL_AEAD_SET_IV_FIXED

When used with a fetched B<EVP_CIPHER>, OPENSSL_BOX_EVP_CIPHER_CTX_set_params() gets called
...
There is no OSSL_PARAM mapping for this. Use OPENSSL_BOX_EVP_CIPHER_CTX_copy() instead.
...
When used with a fetched B<EVP_CIPHER>, OPENSSL_BOX_EVP_CIPHER_CTX_get_params() gets called
with an L<OSSL_PARAM(3)> item with the key
"tlsivgen" (B<OSSL_CIPHER_PARAM_AEAD_TLS1_GET_IV_GEN>).

=item EVP_CTRL_AEAD_TLS1_AAD

When used with a fetched B<EVP_CIPHER>, OPENSSL_BOX_EVP_CIPHER_CTX_set_params() get called
with an L<OSSL_PARAM(3)> item with the key
"tlsaad" (B<OSSL_CIPHER_PARAM_AEAD_TLS1_AAD>)
followed by OPENSSL_BOX_EVP_CIPHER_CTX_get_params() with a key of
...
OPENSSL_BOX_EVP_CIPHER_CTX_set_params() gets called with an L<OSSL_PARAM(3)> item with the
...
followed by OPENSSL_BOX_EVP_CIPHER_CTX_get_params() with keys of
...
OPENSSL_BOX_EVP_CIPHER_CTX_set_flags(), OPENSSL_BOX_EVP_CIPHER_CTX_clear_flags() and OPENSSL_BOX_EVP_CIPHER_CTX_test_flags().
...
Used by OPENSSL_BOX_EVP_CIPHER_CTX_set_padding().
...
See L<OPENSSL_BOX_EVP_CIPHER_meth_set_flags(3)> for further information related to the above
flags.
...
OPENSSL_BOX_EVP_CIPHER_fetch() returns a pointer to a B<EVP_CIPHER> for success
and NULL for failure.

OPENSSL_BOX_EVP_CIPHER_up_ref() returns 1 for success or 0 otherwise.

OPENSSL_BOX_EVP_CIPHER_CTX_new() returns a pointer to a newly created
B<EVP_CIPHER_CTX> for success and NULL for failure.

OPENSSL_BOX_EVP_CIPHER_CTX_dup() returns a new EVP_CIPHER_CTX if successful or NULL on failure.

OPENSSL_BOX_EVP_CIPHER_CTX_copy() returns 1 if successful or 0 for failure.

OPENSSL_BOX_EVP_EncryptInit_ex2(), OPENSSL_BOX_EVP_EncryptUpdate() and OPENSSL_BOX_EVP_EncryptFinal_ex()
return 1 for success and 0 for failure.

OPENSSL_BOX_EVP_DecryptInit_ex2() and OPENSSL_BOX_EVP_DecryptUpdate() return 1 for success and 0 for failure.
OPENSSL_BOX_EVP_DecryptFinal_ex() returns 0 if the decrypt failed or 1 for success.

OPENSSL_BOX_EVP_CipherInit_ex2(), OPENSSL_BOX_EVP_CipherInit_SKEY() and OPENSSL_BOX_EVP_CipherUpdate() return 1 for
success and 0 for failure.
OPENSSL_BOX_EVP_CipherFinal_ex() returns 0 for an encryption/decryption failure or 1 for
success.

OPENSSL_BOX_EVP_Cipher() returns 1 on success and <= 0 on failure, if the flag
B<EVP_CIPH_FLAG_CUSTOM_CIPHER> is not set for the cipher, or if the cipher has
not been initialized via a call to B<OPENSSL_BOX_EVP_CipherInit_ex2>.
OPENSSL_BOX_EVP_Cipher() returns the number of bytes written to I<out> for
...
OPENSSL_BOX_EVP_CIPHER_can_pipeline() returns 1 if the cipher can be used in a pipeline, 0 otherwise.

OPENSSL_BOX_EVP_CipherPipelineEncryptInit() and OPENSSL_BOX_EVP_CipherPipelineDecryptInit()
return 1 for success and 0 for failure.

OPENSSL_BOX_EVP_CipherPipelineUpdate() and OPENSSL_BOX_EVP_CipherPipelineFinal()
return 1 for success and 0 for failure.

OPENSSL_BOX_EVP_CIPHER_CTX_reset() returns 1 for success and 0 for failure.

OPENSSL_BOX_EVP_get_cipherbyname(), EVP_get_cipherbynid() and EVP_get_cipherbyobj()
return an B<EVP_CIPHER> structure or NULL on error.

OPENSSL_BOX_EVP_CIPHER_get_nid() and OPENSSL_BOX_EVP_CIPHER_CTX_get_nid() return a NID.

OPENSSL_BOX_EVP_CIPHER_get_block_size() and OPENSSL_BOX_EVP_CIPHER_CTX_get_block_size() return the
block size, or 0 on error.

OPENSSL_BOX_EVP_CIPHER_get_key_length() and OPENSSL_BOX_EVP_CIPHER_CTX_get_key_length() return the key
length.

OPENSSL_BOX_EVP_CIPHER_CTX_set_padding() always returns 1.

OPENSSL_BOX_EVP_CIPHER_get_iv_length() and OPENSSL_BOX_EVP_CIPHER_CTX_get_iv_length() return the IV
length, zero if the cipher does not use an IV and a negative value on error.

OPENSSL_BOX_EVP_CIPHER_CTX_get_tag_length() return the tag length or zero if the cipher
does not use a tag.

OPENSSL_BOX_EVP_CIPHER_get_type() and EVP_CIPHER_CTX_get_type() return the NID of the
cipher's OBJECT IDENTIFIER or NID_undef if it has no defined
OBJECT IDENTIFIER.

OPENSSL_BOX_EVP_CIPHER_CTX_cipher() returns an B<EVP_CIPHER> structure.

OPENSSL_BOX_EVP_CIPHER_CTX_get_num() returns a nonnegative num value or
B<EVP_CTRL_RET_UNSUPPORTED> if the implementation does not support the call
or on any other error.

OPENSSL_BOX_EVP_CIPHER_CTX_set_num() returns 1 on success and 0 if the implementation
does not support the call or on any other error.

OPENSSL_BOX_EVP_CIPHER_CTX_is_encrypting() returns 1 if the I<ctx> is set up for encryption
0 otherwise.

OPENSSL_BOX_EVP_CIPHER_param_to_asn1() and OPENSSL_BOX_EVP_CIPHER_asn1_to_param() return greater
than zero for success and zero or a negative number on failure.

OPENSSL_BOX_EVP_CIPHER_CTX_rand_key() returns 1 for success and zero or a negative number
for failure.

OPENSSL_BOX_EVP_CIPHER_names_do_all() returns 1 if the callback was called for all names.
...
To specify additional authenticated data (AAD), a call to OPENSSL_BOX_EVP_CipherUpdate(),
OPENSSL_BOX_EVP_EncryptUpdate() or OPENSSL_BOX_EVP_DecryptUpdate() should be made with the output
parameter I<out> set to NULL. In this case, on success, the parameter
I<outl> is set to the number of bytes authenticated.

When decrypting, the return value of OPENSSL_BOX_EVP_DecryptFinal() or OPENSSL_BOX_EVP_CipherFinal()
...
OPENSSL_BOX_EVP_CipherUpdate() depends on the cipher used. Stream ciphers, such as ChaCha20
...
OPENSSL_BOX_EVP_CipherUpdate() call in a single operation.
...
=item OPENSSL_BOX_EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_SET_IVLEN, ivlen, NULL)
...
OPENSSL_BOX_EVP_CipherUpdate(), OPENSSL_BOX_EVP_EncryptUpdate() or OPENSSL_BOX_EVP_DecryptUpdate() with the output
...
=item OPENSSL_BOX_EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_CCM_SET_L, ivlen, NULL)
...
OPENSSL_BOX_EVP_CipherUpdate(), OPENSSL_BOX_EVP_EncryptUpdate() or OPENSSL_BOX_EVP_DecryptUpdate() should be made
...
data and B<after> all data has been processed (e.g. after an OPENSSL_BOX_EVP_EncryptFinal()
...
made B<before> any data is processed (e.g. before any OPENSSL_BOX_EVP_DecryptUpdate()
...
OPENSSL_BOX_EVP_CipherUpdate(), OPENSSL_BOX_EVP_EncryptUpdate() or OPENSSL_BOX_EVP_DecryptUpdate() should be made
with I<out> set to a non-NULL value. A call to OPENSSL_BOX_EVP_DecryptFinal() or
OPENSSL_BOX_EVP_CipherFinal() is not required, but will indicate if the update
operation succeeded.
...
The functions OPENSSL_BOX_EVP_EncryptInit(), OPENSSL_BOX_EVP_EncryptInit_ex(),
OPENSSL_BOX_EVP_EncryptFinal(), OPENSSL_BOX_EVP_DecryptInit(), OPENSSL_BOX_EVP_DecryptInit_ex(),
OPENSSL_BOX_EVP_CipherInit(), OPENSSL_BOX_EVP_CipherInit_ex() and OPENSSL_BOX_EVP_CipherFinal() are obsolete
but are retained for compatibility with existing code. New code should
use OPENSSL_BOX_EVP_EncryptInit_ex2(), OPENSSL_BOX_EVP_EncryptFinal_ex(), OPENSSL_BOX_EVP_DecryptInit_ex2(),
OPENSSL_BOX_EVP_DecryptFinal_ex(), OPENSSL_BOX_EVP_CipherInit_ex2() and OPENSSL_BOX_EVP_CipherFinal_ex()
because they can reuse an existing context without allocating and freeing
it up on each call.

There are some differences between functions OPENSSL_BOX_EVP_CipherInit() and
OPENSSL_BOX_EVP_CipherInit_ex(), significant in some circumstances. OPENSSL_BOX_EVP_CipherInit() fills
the passed context object with zeros.  As a consequence, OPENSSL_BOX_EVP_CipherInit() does
...
Encrypt a string using IDEA:
 ...
 int do_crypt(char *outfile)
 {
     ...
     if (!OPENSSL_BOX_EVP_EncryptInit_ex2(ctx, OPENSSL_BOX_EVP_idea_cbc(), key, iv, NULL)) {
         /* Error */
         OPENSSL_BOX_EVP_CIPHER_CTX_free(ctx);
         return 0;
     }

     if (!OPENSSL_BOX_EVP_EncryptUpdate(ctx, outbuf, &outlen, intext, strlen(intext))) {
         /* Error */
         OPENSSL_BOX_EVP_CIPHER_CTX_free(ctx);
         return 0;
     }
...
with a 128-bit key:
 ...
 int do_crypt(FILE *in, FILE *out, int do_encrypt)
 {
     ...
     ctx = OPENSSL_BOX_EVP_CIPHER_CTX_new();
     if (!OPENSSL_BOX_EVP_CipherInit_ex2(ctx, OPENSSL_BOX_EVP_aes_128_cbc(), NULL, NULL,
                             do_encrypt, NULL)) {
         /* Error */
         OPENSSL_BOX_EVP_CIPHER_CTX_free(ctx);
         return 0;
     }
     OPENSSL_assert(OPENSSL_BOX_EVP_CIPHER_CTX_get_key_length(ctx) == 16);
     OPENSSL_assert(OPENSSL_BOX_EVP_CIPHER_CTX_get_iv_length(ctx) == 16);

     /* Now we can set key and IV */
     if (!OPENSSL_BOX_EVP_CipherInit_ex2(ctx, NULL, key, iv, do_encrypt, NULL)) {
         /* Error */
         OPENSSL_BOX_EVP_CIPHER_CTX_free(ctx);
         return 0;
     }
     ...
     for (;;) {
         ...
         if (inlen <= 0)
             break;
         if (!OPENSSL_BOX_EVP_CipherUpdate(ctx, outbuf, &outlen, inbuf, inlen)) {
             /* Error */
             OPENSSL_BOX_EVP_CIPHER_CTX_free(ctx);
             return 0;
         }
     ...
     if (!OPENSSL_BOX_EVP_CipherFinal_ex(ctx, outbuf, &outlen)) {
         /* Error */
         OPENSSL_BOX_EVP_CIPHER_CTX_free(ctx);
         return 0;
     }
...
Encryption using AES-CBC with a 256-bit key with "CS1" ciphertext stealing.
             ...
             const unsigned char *msg, size_t msg_len, unsigned char *out)
 {
     ...
     */
     ...
     ctx = OPENSSL_BOX_EVP_CIPHER_CTX_new();
     cipher = OPENSSL_BOX_EVP_CIPHER_fetch(NULL, "AES-256-CBC-CTS", NULL);
     ...
     if (!OPENSSL_BOX_EVP_CipherInit_ex2(ctx, cipher, key, iv, encrypt, params))
         goto err;

     /* NOTE: CTS mode does not support multiple calls to OPENSSL_BOX_EVP_CipherUpdate() */
     if (!OPENSSL_BOX_EVP_CipherUpdate(ctx, out, &outlen, msg, msg_len))
         goto err;
      if (!OPENSSL_BOX_EVP_CipherFinal_ex(ctx, out + outlen, &len))
         goto err;
     ret = 1;
 err:
...
L<OPENSSL_BOX_EVP_aes_128_gcm(3)>,
L<OPENSSL_BOX_EVP_aria_128_gcm(3)>,
L<OPENSSL_BOX_EVP_bf_cbc(3)>,
L<OPENSSL_BOX_EVP_camellia_128_ecb(3)>,
L<OPENSSL_BOX_EVP_cast5_cbc(3)>,
L<OPENSSL_BOX_EVP_chacha20(3)>,
L<OPENSSL_BOX_EVP_des_cbc(3)>,
L<OPENSSL_BOX_EVP_desx_cbc(3)>,
L<OPENSSL_BOX_EVP_idea_cbc(3)>,
L<OPENSSL_BOX_EVP_rc2_cbc(3)>,
L<OPENSSL_BOX_EVP_rc4(3)>,
L<OPENSSL_BOX_EVP_rc5_32_12_16_cbc(3)>,
L<OPENSSL_BOX_EVP_seed_cbc(3)>,
L<OPENSSL_BOX_EVP_sm4_cbc(3)>,
...
OPENSSL_BOX_EVP_CIPHER_CTX_reset() appeared and EVP_CIPHER_CTX_cleanup()
disappeared.  EVP_CIPHER_CTX_init() remains as an alias for
OPENSSL_BOX_EVP_CIPHER_CTX_reset().

The OPENSSL_BOX_EVP_CIPHER_CTX_cipher() function was deprecated in OpenSSL 3.0; use
OPENSSL_BOX_EVP_CIPHER_CTX_get0_cipher() instead.

The OPENSSL_BOX_EVP_EncryptInit_ex2(), OPENSSL_BOX_EVP_DecryptInit_ex2(), OPENSSL_BOX_EVP_CipherInit_ex2(),
OPENSSL_BOX_EVP_CIPHER_fetch(), OPENSSL_BOX_EVP_CIPHER_free(), OPENSSL_BOX_EVP_CIPHER_up_ref(),
OPENSSL_BOX_EVP_CIPHER_CTX_get0_cipher(), OPENSSL_BOX_EVP_CIPHER_CTX_get1_cipher(),
OPENSSL_BOX_EVP_CIPHER_get_params(), OPENSSL_BOX_EVP_CIPHER_CTX_set_params(),
OPENSSL_BOX_EVP_CIPHER_CTX_get_params(), OPENSSL_BOX_EVP_CIPHER_gettable_params(),
OPENSSL_BOX_EVP_CIPHER_settable_ctx_params(), OPENSSL_BOX_EVP_CIPHER_gettable_ctx_params(),
OPENSSL_BOX_EVP_CIPHER_CTX_settable_params() and OPENSSL_BOX_EVP_CIPHER_CTX_gettable_params()
...
OPENSSL_BOX_EVP_CIPHER_CTX_is_encrypting() in OpenSSL 3.0. The old name is kept as
non-deprecated alias macro.

The EVP_CIPHER_CTX_flags() macro was deprecated in OpenSSL 1.1.0.

OPENSSL_BOX_EVP_CIPHER_CTX_dup() was added in OpenSSL 3.2.

OPENSSL_BOX_EVP_CipherInit_SKEY() was added in OpenSSL 3.5.

Prior to OpenSSL 3.5, passing a NULL I<ctx> to
B<OPENSSL_BOX_EVP_CIPHER_CTX_get_block_size()> would result in a NULL pointer dereference,
