...
OPENSSL_BOX_EVP_PKEY_sign_init, OPENSSL_BOX_EVP_PKEY_sign_init_ex, EVP_PKEY_sign_init_ex2,
...
the key given through L<OPENSSL_BOX_EVP_PKEY_CTX_new(3)> or L<EVP_PKEY_CTX_new_from_pkey(3)>.
...
When initialized using OPENSSL_BOX_EVP_PKEY_sign_init_ex() or  EVP_PKEY_sign_init_ex2(),
...
The OPENSSL_BOX_EVP_PKEY_sign_init() and EVP_PKEY_sign() functions were added in
OpenSSL 1.0.0.
