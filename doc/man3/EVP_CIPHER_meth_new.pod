...
OPENSSL_BOX_EVP_CIPHER_meth_new, OPENSSL_BOX_EVP_CIPHER_meth_dup, OPENSSL_BOX_EVP_CIPHER_meth_free,
OPENSSL_BOX_EVP_CIPHER_meth_set_iv_length, OPENSSL_BOX_EVP_CIPHER_meth_set_flags,
OPENSSL_BOX_EVP_CIPHER_meth_set_impl_ctx_size, OPENSSL_BOX_EVP_CIPHER_meth_set_init,
OPENSSL_BOX_EVP_CIPHER_meth_set_do_cipher, OPENSSL_BOX_EVP_CIPHER_meth_set_cleanup,
OPENSSL_BOX_EVP_CIPHER_meth_set_set_asn1_params, OPENSSL_BOX_EVP_CIPHER_meth_set_get_asn1_params,
OPENSSL_BOX_EVP_CIPHER_meth_set_ctrl, EVP_CIPHER_meth_get_init,
...
OPENSSL_BOX_EVP_CIPHER_meth_new() creates a new B<EVP_CIPHER> structure.

OPENSSL_BOX_EVP_CIPHER_meth_dup() creates a copy of B<cipher>.

OPENSSL_BOX_EVP_CIPHER_meth_free() destroys a B<EVP_CIPHER> structure.
If the argument is NULL, nothing is done.

OPENSSL_BOX_EVP_CIPHER_meth_set_iv_length() sets the length of the IV.
This is only needed when the implemented cipher mode requires it.

OPENSSL_BOX_EVP_CIPHER_meth_set_flags() sets the flags to describe optional
...
Whenever someone uses OPENSSL_BOX_EVP_CIPHER_CTX_set_key_length() on a
...
Set this to have the implementation's ctrl() function called with
command code B<EVP_CTRL_COPY> at the end of OPENSSL_BOX_EVP_CIPHER_CTX_copy().
...
OPENSSL_BOX_EVP_CIPHER_CTX_get_cipher_data().
...
OPENSSL_BOX_EVP_CIPHER_meth_set_impl_ctx_size() sets the size of the EVP_CIPHER's
implementation context so that it can be automatically allocated.

OPENSSL_BOX_EVP_CIPHER_meth_set_init() sets the cipher init function for
B<cipher>.
The cipher init function is called by OPENSSL_BOX_EVP_CipherInit(),
OPENSSL_BOX_EVP_CipherInit_ex(), OPENSSL_BOX_EVP_EncryptInit(), OPENSSL_BOX_EVP_EncryptInit_ex(),
OPENSSL_BOX_EVP_DecryptInit(), OPENSSL_BOX_EVP_DecryptInit_ex().

OPENSSL_BOX_EVP_CIPHER_meth_set_do_cipher() sets the cipher function for
B<cipher>.
The cipher function is called by OPENSSL_BOX_EVP_CipherUpdate(),
OPENSSL_BOX_EVP_EncryptUpdate(), OPENSSL_BOX_EVP_DecryptUpdate(), OPENSSL_BOX_EVP_CipherFinal(),
OPENSSL_BOX_EVP_EncryptFinal(), OPENSSL_BOX_EVP_EncryptFinal_ex(), OPENSSL_BOX_EVP_DecryptFinal() and
OPENSSL_BOX_EVP_DecryptFinal_ex().

OPENSSL_BOX_EVP_CIPHER_meth_set_cleanup() sets the function for B<cipher> to do
...
OPENSSL_BOX_EVP_CIPHER_CTX_get_cipher_data().
This cleanup function is called by OPENSSL_BOX_EVP_CIPHER_CTX_reset() and
OPENSSL_BOX_EVP_CIPHER_CTX_free().

OPENSSL_BOX_EVP_CIPHER_meth_set_set_asn1_params() sets the function for B<cipher>
to set the AlgorithmIdentifier "parameter" based on the passed cipher.
This function is called by OPENSSL_BOX_EVP_CIPHER_param_to_asn1().
OPENSSL_BOX_EVP_CIPHER_meth_set_get_asn1_params() sets the function for B<cipher>
...
They are called by OPENSSL_BOX_EVP_CIPHER_param_to_asn1() and
OPENSSL_BOX_EVP_CIPHER_asn1_to_param() respectively if defined.

OPENSSL_BOX_EVP_CIPHER_meth_set_ctrl() sets the control function for B<cipher>.
...
OPENSSL_BOX_EVP_CIPHER_meth_new() and OPENSSL_BOX_EVP_CIPHER_meth_dup() return a pointer to a
...
L<OPENSSL_BOX_EVP_EncryptInit(3)>
