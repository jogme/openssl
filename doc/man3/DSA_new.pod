...
Applications should instead use L<OPENSSL_BOX_EVP_PKEY_new(3)> and L<OPENSSL_BOX_EVP_PKEY_free(3)>.
...
L<OPENSSL_BOX_EVP_PKEY_new(3)>, L<OPENSSL_BOX_EVP_PKEY_free(3)>,
