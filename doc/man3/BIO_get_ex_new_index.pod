...
EVP_PKEY_get_ex_new_index, OPENSSL_BOX_EVP_PKEY_set_ex_data, OPENSSL_BOX_EVP_PKEY_get_ex_data,
...
Applications should instead use OPENSSL_BOX_EVP_PKEY_set_ex_data(),
OPENSSL_BOX_EVP_PKEY_get_ex_data() and EVP_PKEY_get_ex_new_index().
