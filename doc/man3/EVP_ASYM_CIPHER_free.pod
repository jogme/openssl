...
OPENSSL_BOX_EVP_ASYM_CIPHER_fetch, OPENSSL_BOX_EVP_ASYM_CIPHER_free, OPENSSL_BOX_EVP_ASYM_CIPHER_up_ref,
OPENSSL_BOX_EVP_ASYM_CIPHER_is_a, OPENSSL_BOX_EVP_ASYM_CIPHER_get0_provider,
OPENSSL_BOX_EVP_ASYM_CIPHER_do_all_provided, OPENSSL_BOX_EVP_ASYM_CIPHER_names_do_all,
OPENSSL_BOX_EVP_ASYM_CIPHER_get0_name, OPENSSL_BOX_EVP_ASYM_CIPHER_get0_description,
OPENSSL_BOX_EVP_ASYM_CIPHER_gettable_ctx_params, OPENSSL_BOX_EVP_ASYM_CIPHER_settable_ctx_params
...
OPENSSL_BOX_EVP_ASYM_CIPHER_fetch() fetches the implementation for the given
...
The returned value must eventually be freed with OPENSSL_BOX_EVP_ASYM_CIPHER_free().

OPENSSL_BOX_EVP_ASYM_CIPHER_free() decrements the reference count for the B<EVP_ASYM_CIPHER>
structure. Typically this structure will have been obtained from an earlier call
to OPENSSL_BOX_EVP_ASYM_CIPHER_fetch(). If the reference count drops to 0 then the
structure is freed. If the argument is NULL, nothing is done.

OPENSSL_BOX_EVP_ASYM_CIPHER_up_ref() increments the reference count for an
B<EVP_ASYM_CIPHER> structure.

OPENSSL_BOX_EVP_ASYM_CIPHER_is_a() returns 1 if I<cipher> is an implementation of an
algorithm that's identifiable with I<name>, otherwise 0.

OPENSSL_BOX_EVP_ASYM_CIPHER_get0_provider() returns the provider that I<cipher> was
fetched from.

OPENSSL_BOX_EVP_ASYM_CIPHER_do_all_provided() traverses all EVP_ASYM_CIPHERs implemented by
...
OPENSSL_BOX_EVP_ASYM_CIPHER_get0_name() returns the algorithm name from the provided
...
OPENSSL_BOX_EVP_ASYM_CIPHER_names_do_all() traverses all names for I<cipher>, and calls
I<fn> with each name and I<data>.

OPENSSL_BOX_EVP_ASYM_CIPHER_get0_description() returns a description of the I<cipher>,
meant for display and human consumption.  The description is at the
discretion of the I<cipher> implementation.

OPENSSL_BOX_EVP_ASYM_CIPHER_gettable_ctx_params() and OPENSSL_BOX_EVP_ASYM_CIPHER_settable_ctx_params()
...
OPENSSL_BOX_EVP_ASYM_CIPHER_fetch() returns a pointer to an B<EVP_ASYM_CIPHER> for success
or B<NULL> for failure.

OPENSSL_BOX_EVP_ASYM_CIPHER_up_ref() returns 1 for success or 0 otherwise.

OPENSSL_BOX_EVP_ASYM_CIPHER_names_do_all() returns 1 if the callback was called for all
