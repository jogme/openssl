...
OPENSSL_BOX_EVP_PKEY_verify_init, OPENSSL_BOX_EVP_PKEY_verify_init_ex, EVP_PKEY_verify_init_ex2,
EVP_PKEY_verify, EVP_PKEY_verify_message_init, EVP_PKEY_verify_message_update,
OPENSSL_BOX_EVP_PKEY_verify_message_final, EVP_PKEY_CTX_set_signature - signature
...
EVP_PKEY_verify_init_ex2() is the same as OPENSSL_BOX_EVP_PKEY_verify_init_ex(), but works
...
EVP_PKEY_verify_message_update() and OPENSSL_BOX_EVP_PKEY_verify_message_final().
...
When initialized using OPENSSL_BOX_EVP_PKEY_verify_init_ex() or  EVP_PKEY_verify_init_ex2(),
...
using EVP_PKEY_verify_message_update() and OPENSSL_BOX_EVP_PKEY_verify_message_final() to
...
EVP_PKEY_verify_recover() and OPENSSL_BOX_EVP_PKEY_verify_message_final() only indicates
...
The OPENSSL_BOX_EVP_PKEY_verify_init() and EVP_PKEY_verify() functions were added in
OpenSSL 1.0.0.
...
EVP_PKEY_verify_message_update(), OPENSSL_BOX_EVP_PKEY_verify_message_final() and
