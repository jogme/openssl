...
OPENSSL_BOX_EVP_PKEY_encrypt_init, EVP_PKEY_encrypt - encrypt using a public key algorithm
...
OPENSSL_BOX_EVP_PKEY_encrypt_init(), OPENSSL_BOX_EVP_PKEY_encrypt_init_ex() and EVP_PKEY_encrypt()
