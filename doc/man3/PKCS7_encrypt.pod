...
OPENSSL_BOX_EVP_des_ede3_cbc() (triple DES) is the algorithm of choice for S/MIME use
because most clients will support it.

Some old "export grade" clients may only support weak encryption using 40 or 64
bit RC2. These can be used by passing OPENSSL_BOX_EVP_rc2_40_cbc() and OPENSSL_BOX_EVP_rc2_64_cbc()
respectively.
