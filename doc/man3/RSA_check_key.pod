...
Applications should instead use L<OPENSSL_BOX_EVP_PKEY_public_check(3)>,
L<OPENSSL_BOX_EVP_PKEY_private_check(3)> and L<OPENSSL_BOX_EVP_PKEY_pairwise_check(3)>.
