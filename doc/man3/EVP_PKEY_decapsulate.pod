...
OPENSSL_BOX_EVP_PKEY_decapsulate_init, EVP_PKEY_auth_decapsulate_init, EVP_PKEY_decapsulate
...
OPENSSL_BOX_EVP_PKEY_decapsulate_init(), EVP_PKEY_auth_decapsulate_init() and
...
The functions OPENSSL_BOX_EVP_PKEY_decapsulate_init() and EVP_PKEY_decapsulate() were added
in OpenSSL 3.0.
