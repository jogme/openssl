...
Applications should instead use L<OPENSSL_BOX_EVP_PKEY_encrypt_init_ex(3)>,
L<OPENSSL_BOX_EVP_PKEY_encrypt(3)>, L<OPENSSL_BOX_EVP_PKEY_decrypt_init_ex(3)> and
...
L<RSA_size(3)>, L<OPENSSL_BOX_EVP_PKEY_decrypt(3)>, L<OPENSSL_BOX_EVP_PKEY_encrypt(3)>
