...
OPENSSL_BOX_PKCS5_PBKDF2_HMAC, OPENSSL_BOX_PKCS5_PBKDF2_HMAC_SHA1 - password based derivation routines with salt and iteration count
...
OPENSSL_BOX_PKCS5_PBKDF2_HMAC() derives a key from a password using a salt and iteration count
...
OPENSSL_BOX_PKCS5_PBKDF2_HMAC_SHA1() calls OPENSSL_BOX_PKCS5_PBKDF2_HMAC() with OPENSSL_BOX_EVP_sha1().
...
OPENSSL_BOX_PKCS5_PBKDF2_HMAC() and PBKCS5_PBKDF2_HMAC_SHA1() return 1 on success or 0 on error.
