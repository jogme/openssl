...
OPENSSL_BOX_EVP_PKEY_encapsulate_init, EVP_PKEY_auth_encapsulate_init, EVP_PKEY_encapsulate
...
OPENSSL_BOX_EVP_PKEY_encapsulate_init(), EVP_PKEY_auth_encapsulate_init() and
...
The functions OPENSSL_BOX_EVP_PKEY_encapsulate_init() and EVP_PKEY_encapsulate() were
