...
OPENSSL_BOX_EVP_PKEY_new(), EVP_PKEY_new_raw_private_key(), EVP_PKEY_new_raw_public_key(),
...
OPENSSL_BOX_EVP_PKEY_up_ref(), EVP_PKEY_get_raw_private_key() and
...
The OPENSSL_BOX_EVP_PKEY_dup(), EVP_PKEY_new_raw_private_key_ex(), and
EVP_PKEY_new_raw_public_key_ex()
