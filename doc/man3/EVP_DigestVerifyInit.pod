...
EVP_DigestVerifyInit_ex, EVP_DigestVerifyInit, OPENSSL_BOX_EVP_DigestVerifyUpdate,
...
EVP_DigestVerifyInit() and OPENSSL_BOX_EVP_DigestVerifyUpdate() return 1 for success and 0
for failure.
...
to calling OPENSSL_BOX_EVP_DigestVerifyUpdate() and EVP_DigestVerifyFinal(). For
...
OPENSSL_BOX_EVP_DigestVerifyUpdate(), EVP_DigestVerifyFinal(), or EVP_DigestVerify().
...
EVP_DigestVerifyInit(), OPENSSL_BOX_EVP_DigestVerifyUpdate() and EVP_DigestVerifyFinal()
