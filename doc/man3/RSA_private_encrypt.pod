...
Applications should instead use L<OPENSSL_BOX_EVP_PKEY_sign_init_ex(3)>,
L<OPENSSL_BOX_EVP_PKEY_sign(3)>, L<OPENSSL_BOX_EVP_PKEY_verify_recover_init(3)>, and
...
L<OPENSSL_BOX_EVP_PKEY_sign(3)>, L<OPENSSL_BOX_EVP_PKEY_verify_recover(3)>
