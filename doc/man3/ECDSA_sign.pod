...
use the higher level B<EVP> interface such as L<OPENSSL_BOX_EVP_DigestSignInit(3)>
or L<OPENSSL_BOX_EVP_DigestVerifyInit(3)> instead.
...
size use L<OPENSSL_BOX_EVP_PKEY_sign(3)> with a NULL I<sig> parameter.
