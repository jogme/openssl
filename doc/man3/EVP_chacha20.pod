...
OPENSSL_BOX_EVP_chacha20,
OPENSSL_BOX_EVP_chacha20_poly1305
...
=item OPENSSL_BOX_EVP_chacha20_poly1305()

Authenticated encryption with ChaCha20-Poly1305. Like OPENSSL_BOX_EVP_chacha20(), the key
...
L<OPENSSL_BOX_EVP_EncryptInit(3)/AEAD Interface> section for more information.
...
L<OPENSSL_BOX_EVP_CIPHER_fetch(3)> with L<EVP_CIPHER-CHACHA(7)> instead.
