...
OPENSSL_BOX_PKCS5_PBE_keyivgen, OPENSSL_BOX_PKCS5_PBE_keyivgen_ex, PKCS5_pbe2_set, PKCS5_pbe2_set_iv,
PKCS5_pbe2_set_iv_ex, PKCS5_pbe_set, PKCS5_pbe_set_ex, PKCS5_pbe2_set_scrypt,
PKCS5_pbe_set0_algor, PKCS5_pbe_set0_algor_ex,
OPENSSL_BOX_PKCS5_v2_PBE_keyivgen, OPENSSL_BOX_PKCS5_v2_PBE_keyivgen_ex,
OPENSSL_BOX_PKCS5_v2_scrypt_keyivgen, OPENSSL_BOX_PKCS5_v2_scrypt_keyivgen_ex,
PKCS5_pbkdf2_set, PKCS5_pbkdf2_set_ex, OPENSSL_BOX_EVP_PBE_scrypt, OPENSSL_BOX_EVP_PBE_scrypt_ex
...
OPENSSL_BOX_PKCS5_PBE_keyivgen() and OPENSSL_BOX_PKCS5_PBE_keyivgen_ex() take a password I<pass> of
...
OPENSSL_BOX_PKCS5_v2_PBE_keyivgen() and OPENSSL_BOX_PKCS5_v2_PBE_keyivgen_ex() are similar to the above
but instead use PKCS#5 PBES2 as the encryption algorithm using the supplied
parameters.

OPENSSL_BOX_PKCS5_v2_scrypt_keyivgen() and OPENSSL_BOX_PKCS5_v2_scrypt_keyivgen_ex() use SCRYPT as the
...
OPENSSL_BOX_PKCS5_PBE_keyivgen(), OPENSSL_BOX_PKCS5_v2_PBE_keyivgen(),
OPENSSL_BOX_PKCS5_v2_PBE_keyivgen_ex(), OPENSSL_BOX_PKCS5_v2_scrypt_keyivgen(),
OPENSSL_BOX_PKCS5_v2_scrypt_keyivgen_ex(), PKCS5_pbe_set0_algor() and
...
L<OPENSSL_BOX_EVP_PBE_CipherInit_ex(3)>,
L<PKCS12_pbe_crypt_ex(3)>,
L<passphrase-encoding(7)>

=head1 HISTORY

OPENSSL_BOX_PKCS5_v2_PBE_keyivgen_ex(), OPENSSL_BOX_EVP_PBE_scrypt_ex(), OPENSSL_BOX_PKCS5_v2_scrypt_keyivgen_ex(),
PKCS5_pbe_set0_algor_ex(), PKCS5_pbe_set_ex(), PKCS5_pbe2_set_iv_ex() and
PKCS5_pbkdf2_set_ex() were added in OpenSSL 3.0.

From OpenSSL 3.0 the PBKDF1 algorithm used in OPENSSL_BOX_PKCS5_PBE_keyivgen() and
OPENSSL_BOX_PKCS5_PBE_keyivgen_ex() has been moved to the legacy provider as an EVP_KDF.
