...
If password-protection is not required, the L<OPENSSL_BOX_i2d_PKCS8PrivateKey(3)> function
...
L<OPENSSL_BOX_i2d_PKCS8PrivateKey(3)>,
L<PEM_read_PrivateKey(3)>,
L<passphrase-encoding(7)>

=head1 HISTORY

L<OPENSSL_BOX_i2d_PKCS8PrivateKey(3)> was added in OpenSSL 3.6.
