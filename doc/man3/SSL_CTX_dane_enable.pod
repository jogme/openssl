...
of the DANE TLSA parameter acronyms) is mapped to C<OPENSSL_BOX_EVP_sha256()>
with a strength ordinal of C<1> and matching type C<SHA2-512(2)>
is mapped to C<OPENSSL_BOX_EVP_sha512()> with a strength ordinal of C<2>.
...
L<OPENSSL_BOX_EVP_PKEY_up_ref(3)> and L<OPENSSL_BOX_EVP_PKEY_free(3)> can be used to acquire and
...
L<X509_up_ref(3)>,
L<X509_free(3)>,
L<OPENSSL_BOX_EVP_get_digestbyname(3)>,
L<OPENSSL_BOX_EVP_PKEY_up_ref(3)>,
