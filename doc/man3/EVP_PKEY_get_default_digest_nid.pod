...
OPENSSL_BOX_EVP_PKEY_get_default_digest_nid, OPENSSL_BOX_EVP_PKEY_get_default_digest_name
...
OPENSSL_BOX_EVP_PKEY_get_default_digest_name() fills in the default message digest
...
OPENSSL_BOX_EVP_PKEY_get_default_digest_nid() sets I<pnid> to the default message
...
OPENSSL_BOX_EVP_PKEY_get_default_digest_name() and OPENSSL_BOX_EVP_PKEY_get_default_digest_nid()
...
L<OPENSSL_BOX_EVP_PKEY_digestsign_supports_digest(3)>,
