...
See L<OPENSSL_BOX_EVP_PKEY_encapsulate(3)> and L<OPENSSL_BOX_EVP_PKEY_decapsulate(3)> for more details
...
This can be set when using OPENSSL_BOX_EVP_PKEY_encapsulate_init().
