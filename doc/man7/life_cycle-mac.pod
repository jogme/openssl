...
=begin man
                 ...
                 +-------------------+
                   |
                   | OPENSSL_BOX_EVP_MAC_CTX_new
                   v
                 +-------------------+
                 |       newed       |
                 +-------------------+
                   |
                   | OPENSSL_BOX_EVP_MAC_init
                   v
                 +-------------------+
              +> |    initialised    | <+
              |  +-------------------+  |
              |    |                    |
              |    | OPENSSL_BOX_EVP_MAC_update     | OPENSSL_BOX_EVP_MAC_init
              |    v                    |
 OPENSSL_BOX_EVP_MAC_init |  +-------------------+  |
              |  |      updated      | -+
              |  +-------------------+
              |    |               |
              |    | OPENSSL_BOX_EVP_MAC_final | OPENSSL_BOX_EVP_MAC_finalXOF
              |    v               v
              |  +-------------------+
              +- |      finaled      |
                 +-------------------+
                   |
                   | OPENSSL_BOX_EVP_MAC_CTX_free
                   v
                 +-------------------+
                 |       freed       |
                 +-------------------+
...
=begin man
 ...
 OPENSSL_BOX_EVP_MAC_CTX_new                 newed
 OPENSSL_BOX_EVP_MAC_init                         initialised initialised initialised initialised
 OPENSSL_BOX_EVP_MAC_update                                     updated     updated
 OPENSSL_BOX_EVP_MAC_final                                                  finaled
 OPENSSL_BOX_EVP_MAC_finalXOF                                               finaled
 OPENSSL_BOX_EVP_MAC_CTX_free                freed   freed       freed       freed       freed
 OPENSSL_BOX_EVP_MAC_CTX_get_params                  newed    initialised   updated
 OPENSSL_BOX_EVP_MAC_CTX_set_params                  newed    initialised   updated
 OPENSSL_BOX_EVP_MAC_CTX_gettable_params             newed    initialised   updated
 OPENSSL_BOX_EVP_MAC_CTX_settable_params             newed    initialised   updated
...
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_MAC_CTX_new</th>
...
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_MAC_init</th>
    <td style="border:1px solid" align="center"></td>
    ...
    <td style="border:1px solid" align="center">initialised</td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_MAC_update</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td>
    ...
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_MAC_final</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td>
    ...
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_MAC_finalXOF</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">finaled</td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_MAC_CTX_free</th>
    ...
    <td style="border:1px solid" align="center">freed</td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_MAC_CTX_get_params</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">newed</td>
    <td style="border:1px solid" align="center">initialised</td>
    <td style="border:1px solid" align="center">updated</td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_MAC_CTX_set_params</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">newed</td>
    <td style="border:1px solid" align="center">initialised</td>
    <td style="border:1px solid" align="center">updated</td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_MAC_CTX_gettable_params</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">newed</td>
    <td style="border:1px solid" align="center">initialised</td>
    <td style="border:1px solid" align="center">updated</td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_MAC_CTX_settable_params</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">newed</td>
    <td style="border:1px solid" align="center">initialised</td>
    <td style="border:1px solid" align="center">updated</td>
