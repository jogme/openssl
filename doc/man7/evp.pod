...
functions.  The L<B<EVP_Digest>I<XXX>|OPENSSL_BOX_EVP_DigestInit(3)> functions provide message digests.
...
L<EVP_PKEY_print_private(3)>. L<OPENSSL_BOX_EVP_PKEY_todata(3)> can be used to convert a
