...
functions L<OPENSSL_BOX_EVP_PKEY_sign(3)>, L<OPENSSL_BOX_EVP_PKEY_verify(3)>,
and L<OPENSSL_BOX_EVP_PKEY_verify_recover(3)> (as well as other related functions).
...
both checked using L<OPENSSL_BOX_EVP_SIGNATURE_is_a(3)>.
...
L<OPENSSL_BOX_EVP_SIGNATURE_is_a(3)>, L<ASN1_item_sign_ctx(3)>
