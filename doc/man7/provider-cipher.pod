...
them available to applications via the API functions L<OPENSSL_BOX_EVP_EncryptInit_ex(3)>,
L<OPENSSL_BOX_EVP_EncryptUpdate(3)> and L<OPENSSL_BOX_EVP_EncryptFinal(3)> (as well as the decrypt
...
locations, the requirements of L<OPENSSL_BOX_EVP_EncryptUpdate(3)> and L<OPENSSL_BOX_EVP_DecryptUpdate(3)>
guarantee that the two buffers are disjoint.
Similarly, the requirements of L<OPENSSL_BOX_EVP_EncryptUpdate(3)> and L<OPENSSL_BOX_EVP_DecryptUpdate(3)>
...
L<OPENSSL_BOX_EVP_EncryptFinal(3)> and L<OPENSSL_BOX_EVP_DecryptFinal(3)>.
...
All arrays are of length I<numpipes>. See L<OPENSSL_BOX_EVP_CipherPipelineEncryptInit(3)> for more
information.
...
L<life_cycle-cipher(7)>, L<OPENSSL_BOX_EVP_EncryptInit(3)>
