...
See L<OPENSSL_BOX_EVP_PKEY_encapsulate(3)> and L<OPENSSL_BOX_EVP_PKEY_decapsulate(3)> for more info.
...
This can be set using either OPENSSL_BOX_EVP_PKEY_CTX_set_kem_op() or
...
L<OPENSSL_BOX_EVP_PKEY_CTX_set_kem_op(3)>,
