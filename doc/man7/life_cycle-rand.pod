...
=begin man
                        ...
                        +-------------------------+
                          |
                          | OPENSSL_BOX_EVP_RAND_CTX_new
                          v
                        +-------------------------+
                        |          newed          |
                        +-------------------------+
                          |
                          | OPENSSL_BOX_EVP_RAND_instantiate
                          v
    OPENSSL_BOX_EVP_RAND_generate   +-------------------------+
  +-------------------- |                         |
  |                     |      instantiated       |
  +-------------------> |                         | <+
                        +-------------------------+  '
                          |                          '
                          | OPENSSL_BOX_EVP_RAND_uninstantiate   ' OPENSSL_BOX_EVP_RAND_instantiate
                          v                          '
                        +-------------------------+  '
                        |     uninstantiated      | -+
                        +-------------------------+
                          |
                          | OPENSSL_BOX_EVP_RAND_CTX_free
                          v
                        +-------------------------+
                        |          freed          |
                        +-------------------------+
...
=begin man
 ...
 OPENSSL_BOX_EVP_RAND_CTX_new           newed
 OPENSSL_BOX_EVP_RAND_instantiate            instantiated
 OPENSSL_BOX_EVP_RAND_generate                          instantiated
 OPENSSL_BOX_EVP_RAND_uninstantiate                    uninstantiated
 OPENSSL_BOX_EVP_RAND_CTX_free          freed   freed      freed          freed
 OPENSSL_BOX_EVP_RAND_CTX_get_params            newed   instantiated  uninstantiated  freed
 OPENSSL_BOX_EVP_RAND_CTX_set_params            newed   instantiated  uninstantiated  freed
 OPENSSL_BOX_EVP_RAND_CTX_gettable_params       newed   instantiated  uninstantiated  freed
 OPENSSL_BOX_EVP_RAND_CTX_settable_params       newed   instantiated  uninstantiated  freed
...
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_RAND_CTX_new</th>
    <td style="border:1px solid" align="center">newed</td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_RAND_instantiate</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">instantiated</td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_RAND_generate</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">instantiated</td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_RAND_uninstantiate</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">uninstantiated</td>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_RAND_CTX_free</th>
    <td style="border:1px solid" align="center">freed</td>
    <td style="border:1px solid" align="center">freed</td>
    <td style="border:1px solid" align="center">freed</td>
    <td style="border:1px solid" align="center">freed</td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_RAND_CTX_get_params</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">newed</td>
    <td style="border:1px solid" align="center">instantiated</td>
    <td style="border:1px solid" align="center">uninstantiated</td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_RAND_CTX_set_params</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">newed</td>
    <td style="border:1px solid" align="center">instantiated</td>
    <td style="border:1px solid" align="center">uninstantiated</td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_RAND_CTX_gettable_params</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">newed</td>
    <td style="border:1px solid" align="center">instantiated</td>
    <td style="border:1px solid" align="center">uninstantiated</td>
    <td style="border:1px solid" align="center"></td></tr>
<tr><th style="border:1px solid" align="left">OPENSSL_BOX_EVP_RAND_CTX_settable_params</th>
    <td style="border:1px solid" align="center"></td>
    <td style="border:1px solid" align="center">newed</td>
    <td style="border:1px solid" align="center">instantiated</td>
    <td style="border:1px solid" align="center">uninstantiated</td>
