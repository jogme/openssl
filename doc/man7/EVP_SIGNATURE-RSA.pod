...
L<RSA keys|EVP_PKEY-RSA(7)>) with L<OPENSSL_BOX_EVP_DigestSignInit(3)> and
...
are all supported explicitly fetched with L<OPENSSL_BOX_EVP_PKEY_sign_init_ex2(3)> and
