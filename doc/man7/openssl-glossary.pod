...
implementation such as L<OPENSSL_BOX_EVP_MD_fetch(3)> or L<OPENSSL_BOX_EVP_CIPHER_fetch(3)>
...
return value from L<OPENSSL_BOX_EVP_sha256(3)> or L<OPENSSL_BOX_EVP_aes_128_cbc(3)>. With implicit
