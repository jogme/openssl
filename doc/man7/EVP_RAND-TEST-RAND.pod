...
A context for a test generator can be obtained by calling:
 ...
 EVP_RAND *rand = OPENSSL_BOX_EVP_RAND_fetch(NULL, "TEST-RAND", NULL);
...
=head1 EXAMPLES
 ...
 rand = OPENSSL_BOX_EVP_RAND_fetch(NULL, "TEST-RAND", NULL);
 rctx = OPENSSL_BOX_EVP_RAND_CTX_new(rand, NULL);
