...
To set explicit parameters, use OPENSSL_BOX_EVP_PKEY_CTX_set_params() after calling
OPENSSL_BOX_EVP_PKEY_keygen_init().
...
the OPENSSL_BOX_EVP_PKEY_fromdata() and OPENSSL_BOX_EVP_PKEY_todata() functions.
...
An B<EVP_PKEY> context can be obtained by calling:
    ...
    EVP_PKEY_CTX *pctx =
        OPENSSL_BOX_EVP_PKEY_CTX_new_from_name(NULL, "ML-KEM-768", NULL);

An B<ML-KEM-768> key can be generated like this:

    pkey = OPENSSL_BOX_EVP_PKEY_Q_keygen(NULL, NULL, "ML-KEM-768");
