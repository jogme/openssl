...
OPENSSL_BOX_EVP_PKEY_CTX_set_params() after calling OPENSSL_BOX_EVP_PKEY_keygen_init().
...
An B<EVP_PKEY> context can be obtained by calling:
    ...
    EVP_PKEY_CTX *pctx =
        OPENSSL_BOX_EVP_PKEY_CTX_new_from_name(NULL, "X25519", NULL);

    EVP_PKEY_CTX *pctx =
        OPENSSL_BOX_EVP_PKEY_CTX_new_from_name(NULL, "X448", NULL);

    EVP_PKEY_CTX *pctx =
        OPENSSL_BOX_EVP_PKEY_CTX_new_from_name(NULL, "ED25519", NULL);

    EVP_PKEY_CTX *pctx =
        OPENSSL_BOX_EVP_PKEY_CTX_new_from_name(NULL, "ED448", NULL);

An B<X25519> key can be generated like this:

    pkey = OPENSSL_BOX_EVP_PKEY_Q_keygen(NULL, NULL, "X25519");
