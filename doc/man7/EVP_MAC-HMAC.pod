...
The following parameters can be set with OPENSSL_BOX_EVP_MAC_CTX_set_params():
...
The following parameters can be retrieved with OPENSSL_BOX_EVP_MAC_CTX_get_params():

=over 4

=item "size" (B<OSSL_MAC_PARAM_SIZE>) <unsigned integer>

The "size" parameter can also be retrieved with OPENSSL_BOX_EVP_MAC_CTX_get_mac_size().
